...
- This repository maps by default to Mouvadah project **#5 — Taskable Platform
  — Harness Enablement**, unless the user explicitly selects a different
  project.
...
- Run the narrowest relevant tests first, then expand in proportion to risk.
- Do not mark a ticket complete or record a knowledge claim until the supporting
